 ...
 * the source is escaped rather than passed through, since this markdown is LLM-authored,
 * untrusted text (spec: "XSS-safe: file contents and LLM output are untrusted text — never
 * inject raw into HTML"). Code spans/blocks are escaped by marked itself by default.
 */
