...
export interface PageInput {
  ...
  /** Display line for the Tulip build that produced this page (see src/version.ts's
   * `formatVersion`), rendered in a small page footer so a reader can tell which version to
   * blame/credit. Optional so callers that don't care about the footer's exact text (most
...
<p>Generated by ${escapeHtml(input.generatedBy ?? "Tulip")}</p>
</footer>
</main>
