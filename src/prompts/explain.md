...
A diagram must read at prose width. Lay flowcharts out top-down (`flowchart TD`); stack
before/after or alternative subgraphs under each other, never side by side; keep at most five
nodes across, and at most five participants in a sequence diagram. Split anything wider into two
diagrams.
